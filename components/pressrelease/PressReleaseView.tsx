  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-4 gap-10">
      ...
      >
        ...
        {/* Featured Image */}
        {pressRelease?.featured_image && (
          <div className="mb-8 rounded-lg overflow-hidden border border-gray-100 shadow-sm">
            <img
              src={typeof pressRelease?.featured_image === "string" ? pressRelease?.featured_image : URL.createObjectURL(pressRelease?.featured_image)}
        ...
        <div className="border border-gray-200 rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            {pressRelease?.company_logo && (
              <img
                src={typeof pressRelease?.company_logo === "string" ? pressRelease?.company_logo : URL.createObjectURL(pressRelease?.company_logo)}
